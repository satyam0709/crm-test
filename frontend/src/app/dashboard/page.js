...
const QUICK_LINKS = [
  { icon: "fas fa-plus-circle", label: "Add New Lead",  href: "/dashboard/leads/new", color: "#F5C400", bg: "rgba(245,196,0,0.12)" },
  { icon: "fas fa-calendar-check", label: "View Tasks", href: "/dashboard/tasks",     color: "#1d4ed8", bg: "#eff6ff" },
  { icon: "fas fa-users",       label: "All Leads",     href: "/dashboard/leads",     color: "#15803d", bg: "#f0fdf4" },
  { icon: "fas fa-chart-bar",   label: "Reports",       href: "/dashboard/reports",   color: "#7e22ce", bg: "#fdf4ff" },
];
